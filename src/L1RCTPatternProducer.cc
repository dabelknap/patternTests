  ...
  if(nEvents < 64)
   ...
   /*
		...
		if(iTower==3&&iCard==3)
		  hcal = iCrate;
		*/
		//CRATE 9 and 17 sharing problem (solved)
// 		if(iCard==6) {
// 		  if(nEvents<16) {
// 		    if(iTower==0)
// 		      ecal=0x2f;
...
// 	 	  if(nEvents<16) {
// 		    if(iTower==31) {
// 		      hcal=0xf; //need to be fgEcalE???
// 		      fgbit=1;
// 		    }
// 		  }
// 		}
// 		  if(nEvents<32&&nEvents>=16) {
// 		    if(iTower==8)
// 		      ecal=0xf;
// 		    if(iTower==19) {
// 		      fgbit=1;
...
// 		    }
// 		  }
// 		  if(nEvents>=32&&nEvents<48) {
// 		    if(iTower==27)
// 		      ecal=0xf;
// 		    if(iTower==0) {
// 		      hcal=fgEcalE; //need to be fgEcalE???
// 		      fgbit=1;
// 		    }
// 		  }
// 		  if(nEvents>=48) {
...
// 		  }
		  //}
		//FOR HCAL LINK TESTS
// 		if(iCrate==0 && iCard==0 && iTower==nEvents)
// 		  hcal = nEvents;

// 		if(iCrate==17 && iCard==1 && iTower==nEvents)
// 		  hcal = nEvents;

// 		if(iCrate==1 && iCard==1 && iTower==nEvents)
// 		  hcal = nEvents;

// 		if(iCrate==16 && iCard==0 && iTower==nEvents)
// 		  hcal = nEvents;

// 		if(iCrate==2 && iCard==2 && iTower==nEvents)
// 		  hcal = nEvents;

// 		if(iCrate==15 && iCard==3 && iTower==nEvents)
// 		  hcal = nEvents;
	      }
